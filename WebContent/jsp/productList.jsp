...
<%!
    private String thumbFor(String path) {
        ...
        if (lp.endsWith(".pdf"))  return "&#128218;";
        if (lp.endsWith(".docx") || lp.endsWith(".doc")) return "&#128221;";
        if (lp.endsWith(".zip"))  return "&#128230;";
        if (lp.endsWith(".png") || lp.endsWith(".jpg") || lp.endsWith(".jpeg")) return "&#127912;";
        return "&#128196;";
    }
%>
<%
    ...
    // Fix: pre-compute class strings — no quotes inside JSP expressions
...
<head>
  ...
  <style>
    ...
    .search-form input[type="text"] {
      ...
      padding: 14px 22px; font-size: 0.97rem;
    ...
    .search-form button {
      ...
      color: white; min-width: 56px;
    }
    .search-form button:hover { background: #c9622a; }
    .search-clear {
      display: inline-flex; align-items: center; gap: 6px;
      background: #f5f5f5; border: 1px solid #ddd; color: #555;
      padding: 7px 16px; border-radius: 20px;
      font-size: 0.83rem; text-decoration: none; margin-top: 10px;
    }
    .search-clear:hover { background: #ebebeb; text-decoration: none; }
    .search-info {
      background: #fff8f3; border: 1px solid #fde2cc;
      border-radius: 10px; padding: 12px 18px; margin-bottom: 24px;
      font-size: 0.9rem; color: #7a4010;
      display: flex; align-items: center;
      justify-content: space-between; flex-wrap: wrap; gap: 8px;
    }
    .search-info strong { color: #e07b39; }
    .category-nav {
    ...
    .category-nav a.active {
      background: #e07b39; border-color: #e07b39;
    ...
    .hero-search-wrap p {
      color: #777; font-size: 1rem; margin-bottom: 28px;
    }
  </style>
</head>
<body>
...
<% if (_isSeller) { %>
  ...
  <div class="stats-row">
    ...
    <div class="stat-card">
      ...
      <div class="value" style="color:green;">Live</div>
...
<% } else { %>
  ...
  <div class="hero-search-wrap">
    ...
    <%-- Category filters — class computed in Java, no quotes-in-quotes --%>
      ...
      <% for (Product p : _products) { %>
        <article class="card">
          <div class="card-thumb">
            <%= thumbFor(p.getFilePath()) %>
            <% if (_isSeller && p.getSellerId() == _user.getUserId()) { %>
